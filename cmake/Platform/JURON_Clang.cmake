...
if ( with-openmp )
  if ( with-offload )
    set(OpenMP_CXX_FLAGS "-fopenmp -fopenmp-targets=nvptx64" CACHE STRING "Compiler flag for OpenMP offloading" FORCE )
    set(OpenMP_C_FLAGS "-fopenmp -fopenmp-targets=nvptx64" CACHE STRING "Compiler flag for OpenMP offloading" FORCE )
  else()
